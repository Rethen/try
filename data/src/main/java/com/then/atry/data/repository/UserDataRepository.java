...
import com.then.atry.data.repository.datasource.UserDataStoreFactory;
...
public class UserDataRepository implements UserRepository {
    ...
    public Observable<List<User>> users() {
        ...
        return userDataStore.userEntityList().map(this.userEntityDataMapper::apply);
    }

    @Override
    public Observable<User> user(int userId) {
        final UserDataStore userDataStore = this.userDataStoreFactory.create(userId);
        return userDataStore.userEntityDetails(userId).map(this.userEntityDataMapper::apply);
    }
}
