...
public class UseCaseTest {
  ...
  public void setUp() {
    ...
    this.useCase = new UseCaseTestClass(mockThreadExecutor, mockPostExecutionThread,requestFilter);
  }
  ...
  private static class UseCaseTestClass extends UseCase {
    ...
    protected UseCaseTestClass(ThreadExecutor threadExecutor, PostExecutionThread postExecutionThread, RequestFilter requestFilter) {
