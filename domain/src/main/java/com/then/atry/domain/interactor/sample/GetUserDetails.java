...
public class GetUserDetails extends UseCase {
    ...
    public GetUserDetails(int userId, UserRepository userRepository,
                          ThreadExecutor threadExecutor, PostExecutionThread postExecutionThread, RequestFilter requestFilter) {
    ...
    @Override
    public Observable buildUseCaseObservable(String header, RequestBody content) {
        return null;
    }
