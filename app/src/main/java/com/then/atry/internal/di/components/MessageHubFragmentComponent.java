...
import com.then.atry.internal.di.modules.GraphqlModule;
 ...
 */
@PerActivity
@Component(dependencies = ApplicationComponent.class, modules = {ActivityModule.class,  GraphqlModule.class})
