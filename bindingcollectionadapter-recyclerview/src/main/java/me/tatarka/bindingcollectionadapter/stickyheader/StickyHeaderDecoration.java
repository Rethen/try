...
package me.tatarka.bindingcollectionadapter.stickyheader;
...
public class StickyHeaderDecoration extends RecyclerView.ItemDecoration {
    ...
    public StickyHeaderDecoration(@LayoutRes int layoutRes,int bindingVariable) {
        this( false,layoutRes,bindingVariable);
    }

    public StickyHeaderDecoration( boolean renderInline,int layoutRes,int bindingVariable) {
    ...
    private RecyclerView.ViewHolder getHeader(RecyclerView parent, int position) {
        ...
        if (mHeaderCache.containsKey(key)) {
            ...
            final RecyclerView.ViewHolder holder = mAdapter.onCreateHeaderViewHolder(parent,layoutRes);
            final View header = holder.itemView;

            //noinspection unchecked
            mAdapter.onBindHeaderViewHolder(holder, position,bindingVariable);
    ...
    public void setmAdapter(StickyHeaderAdapter mAdapter) {
